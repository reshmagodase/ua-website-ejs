        ...
        $scope.getData = function () {
            ...
            $http({
                ...
                .success(function (data, status) {
                    ...
                    /* var html = '';
                     for (var i = 0; i < data.length; i++) {
                     html += '<div class="item"> <a class="post" href="case-studies/' + data[i].slug + '"> <img class="main-pic" src="' + data[i].thumbImage + '" style="height:200px;"> <div class="info"> <h2>' + data[i].title + '</h2> <p>' + data[i].home_page_listing_excerpt + '</p> </div> </a> </div>'
                     }*/
